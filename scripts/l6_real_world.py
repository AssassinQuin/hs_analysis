...
UNIFIED_PATH = os.path.join(PROJECT_ROOT, "hs_cards", "unified_standard.json")
V2_REPORT_PATH = os.path.join(PROJECT_ROOT, "hs_cards", "v2_scoring_report.json")
L6_REPORT_PATH = os.path.join(PROJECT_ROOT, "hs_cards", "l6_scoring_report.json")

# Import from fetch_hsreplay (same directory) — it wraps sys.stdout at import
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from fetch_hsreplay import init_db, get_all_cached_stats, get_meta_decks

# Ensure stdout supports UTF-8 (fetch_hsreplay already wrapped it for us)
# Do NOT re-wrap — double TextIOWrapper causes "I/O operation on closed file"
