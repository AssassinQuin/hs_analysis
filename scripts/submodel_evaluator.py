...
Runnable independently:  python3 scripts/submodel_evaluator.py
"""
...
from game_state import GameState, Minion  # noqa: E402
...
if __name__ == "__main__":
    from game_state import Weapon, HeroState, OpponentState, Card, ManaState
