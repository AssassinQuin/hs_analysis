...
Usage: python -m pytest scripts/test_v8_contextual_scorer.py -v
"""
...
from game_state import Card, GameState  # type: ignore[import]
...
class V8ContextualScorer:
    ...
    def __init__(self, data_dir: Optional[str] = None):
        self._data_dir = data_dir or os.path.join(BASE_DIR, "hs_cards")
