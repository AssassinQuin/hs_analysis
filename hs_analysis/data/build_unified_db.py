...
from hs_analysis.config import DATA_DIR, UNIFIED_DB_PATH

sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding="utf-8", errors="replace")

RAW_PATH = str(DATA_DIR / "iyingdi_standard_raw.json")
HSJSON_PATH = str(DATA_DIR / "hsjson_standard.json")
LEGEND_PATH = str(DATA_DIR / "standard_legendaries_analysis.json")
