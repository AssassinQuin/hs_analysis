...
Data sources:
  - hs_cards/hsreplay_cache.db → meta_decks table (archetype signatures)
  - hs_cards/unified_standard.json → card name lookups
"""
import sys
import os
import json
...
from hs_analysis.config import PROJECT_ROOT, HSREPLAY_CACHE_DB, UNIFIED_DB_PATH
...
try:
    from hs_analysis.data.fetch_hsreplay import init_db, get_meta_decks
except ImportError:
