"""DecisionPipeline — V11 main entry point.
...
from hs_analysis.search.engine_v11.strategic import strategic_decision, StrategicMode
from hs_analysis.search.engine_v11.tactical import TacticalPlanner, TacticalCandidate
from hs_analysis.search.engine_v11.action_pruner import ActionPruner
from hs_analysis.search.engine_v11.attack_planner import AttackPlanner, AttackPlan
from hs_analysis.search.engine_v11.factors.factor_graph import (
    FactorGraphEvaluator, FactorScores,
)
from hs_analysis.search.engine_v11.factors.factor_base import EvalContext
from hs_analysis.search.engine_v11.factors.board_control import BoardControlFactor
from hs_analysis.search.engine_v11.factors.lethal_threat import LethalThreatFactor
from hs_analysis.search.engine_v11.factors.tempo import TempoFactor
from hs_analysis.search.engine_v11.factors.value import ValueFactor
from hs_analysis.search.engine_v11.factors.survival import SurvivalFactor
from hs_analysis.search.engine_v11.factors.resource_efficiency import ResourceEfficiencyFactor
from hs_analysis.search.engine_v11.factors.discover_ev import DiscoverEVFactor
from hs_analysis.search.engine_v11.mechanics.registry import MechanicRegistry
...
def _build_default_registry() -> MechanicRegistry:
    registry = MechanicRegistry()
    from hs_analysis.search.engine_v11.mechanics.battlecry_handler import BattlecryHandler
    from hs_analysis.search.engine_v11.mechanics.deathrattle_handler import DeathrattleHandler
    from hs_analysis.search.engine_v11.mechanics.discover_handler import DiscoverHandler
    from hs_analysis.search.engine_v11.mechanics.colossal_handler import ColossalHandler
    from hs_analysis.search.engine_v11.mechanics.aura_handler import AuraHandler
    from hs_analysis.search.engine_v11.mechanics.trigger_handler import (
        TriggerOnPlayHandler, TriggerOnDeathHandler, TriggerOnAttackHandler, TriggerOnSpellHandler,
    )
    from hs_analysis.search.engine_v11.mechanics.phase3_handlers import (
        OutcastHandler, KindredHandler, HeraldHandler, QuestHandler,
        ImbueHandler, DormantHandler,
    )

    for h in [
        BattlecryHandler(), DeathrattleHandler(), DiscoverHandler(),
        ColossalHandler(), AuraHandler(),
        TriggerOnPlayHandler(), TriggerOnDeathHandler(),
        TriggerOnAttackHandler(), TriggerOnSpellHandler(),
        OutcastHandler(), KindredHandler(), HeraldHandler(),
        QuestHandler(), ImbueHandler(), DormantHandler(),
    ]:
        registry.register(h.__class__.__name__, h)
    return registry


class DecisionPipeline:
    def __init__(self, evaluator: Optional[FactorGraphEvaluator] = None,
                 registry: Optional[MechanicRegistry] = None,
