...
from hs_analysis.search.rhea_engine import Action, apply_action, enumerate_legal_actions
...
def check_lethal(state: GameState, time_budget_ms: float = 5.0) -> Optional[List[Action]]:
