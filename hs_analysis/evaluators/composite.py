#!/usr/bin/env python3
"""
composite.py — Composite State Evaluator for Hearthstone AI Decision Engine.
...
Usage:
    python -m hs_analysis.evaluators.composite          # run built-in demo / self-test
"""
...
# Package imports
# ---------------------------------------------------------------------------
from hs_analysis.search.game_state import GameState, Minion, HeroState, OpponentState, ManaState
...
# ---------------------------------------------------------------------------
try:
    from hs_analysis.evaluators.submodel import (
        eval_board,
        eval_threat,
        eval_lingering,
        eval_trigger,
