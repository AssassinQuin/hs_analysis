...
class TestFactorGraph:
    ...
    def test_all_factors_registered(self):
        from analysis.search.engine.pipeline import _build_default_evaluator
...
class TestAttackPlanner:
    def test_plan_finds_lethal(self):
        from analysis.search.engine.attack_planner import AttackPlanner
...
class TestStrategic:
    def test_lethal_mode(self):
        from analysis.search.engine.strategic import strategic_decision
